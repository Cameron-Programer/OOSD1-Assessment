...
- [ ] The code must include 
  ...
  - [ ] docstrings explaining the purpose and functionality of all
  functions and classes.

#### Test Cases

- [ ] Suitable test cases have been identified and documented
 Total more than 10 and less than 15 testcases provided for the
 project

#### UML diagrams
- [ ] Provide appropriate UML diagrams related to the project with
...
project works. Your presentation should cover the following points.
